...
Webflow.require('ix').init([
  {"slug":"opacity-0-on-load","name":"Opacity 0% on Load","value":{"style":{"opacity":0},"triggers":[]}},
  {"slug":"on-load-delay-fade-in","name":"On Load Delay Fade In","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":2400},{"opacity":1,"transition":"opacity 600ms ease-in-out-quad 0ms"}],"stepsB":[]}]}},
  {"slug":"hero-section","name":"Hero Section","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 600ms ease-in-out-quad 0ms"}],"stepsB":[]},{"type":"scroll","selector":".fixed-header","offsetTop":"1px","stepsA":[{"opacity":0,"transition":"opacity 600ms ease-in-out-quad 0ms"},{"display":"none"}],"stepsB":[{"display":"block","opacity":0},{"opacity":0.98,"transition":"opacity 600ms ease-in-out-quad 0ms"}]}]}},
  {"slug":"white-heading-text-2","name":"White Heading Text 2","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":800},{"opacity":1,"transition":"opacity 600ms ease-in-out-quad 0ms"},{"wait":100},{"transition":"transform 300ms ease-in-out-quad 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
